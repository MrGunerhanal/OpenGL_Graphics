...
void COpenAssetImportMesh::TranslateByKeyboard(double dt)
{
...
void COpenAssetImportMesh::Strafe(double direction)
{
...
void COpenAssetImportMesh::Advance(double direction)
{
    float speed = (float)(m_speed * direction);
...
void COpenAssetImportMesh::Update(double dt)
{
...
glm::vec3 COpenAssetImportMesh::GetPosition() const
{
    return m_position;
}
